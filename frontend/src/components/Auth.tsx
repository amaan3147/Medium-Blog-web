import { SignupInput } from "@aman3147/medium-common";
    ...
    return <div className="h-screen flex justify-center flex-col">
             <div className="flex justify-center">
                <div>
                    ...
                    <div className="pt-8">
                        {type === "signup" ? <LabelledInput label="Name" placeholder="aman shaikh" onChange={(e) => {
                            setPostInputs({
                                ...postInputs,
                                name: e.target.value
                            })
                        }} /> : null }
                        <LabelledInput label="Username" placeholder="aman@gmail.com" onChange={(e) => {
                            setPostInputs({
                                ...postInputs,
...
function LabelledInput({label, placeholder, onChange, type }: LabbelledInputType){
    return <div>
